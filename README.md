...
- Key UI elements:
  ...
  - Onboarding via “Create+” button for Event or Item listings.
...
- **How to Use LifePub**:
  ...
  3. Use **Create+** to post an event or item.
  4. Browse events and items using filters or keyword search.
  5. RSVP to events or chat and transact via Stripe for items.
- **FAQs**:
...
| Hoang Nguyen| 45 hrs       | 45 hrs         | 90 hrs | Frontend, Project Management, Testing |
| Long Vo     | 45 hrs       | 45 hrs         | 90 hrs | Backend, Messaging, API Integration |
