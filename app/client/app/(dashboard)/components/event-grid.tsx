// app/components/landing/EventGrid.jsx
    ...
    return (
        <div className="mb-12">
            <h2 className="text-xl md:text-2xl font-semibold mb-6 flex items-center">
                <span className="mr-2">🎭</span> {eventTabs[activeTab] === 'For you' ? 'Our top picks for you' : `${eventTabs[activeTab]} events`}
                {activeCategory !== null && (
                    <Badge className="ml-3 bg-blue-100 text-blue-800 hover:bg-blue-200 cursor-pointer" onClick={() => setActiveCategory(null)}>
