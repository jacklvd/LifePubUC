            ...
            <div className="flex h-full">
              ...
              <div className="flex-1 flex justify-center items-center gap-4 p-4 md:w-1/2">
                {slide.features.map((feature, idx) => (
                  <div
                    key={idx}
                    className="relative w-40 h-40 overflow-hidden rounded-lg shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
                  >
                    <div className="h-full w-full bg-gradient-to-br from-blue-400 to-indigo-600 flex items-center justify-center">
                      <p className="font-bold text-white text-center px-2">
                        {feature.title}
                      </p>
                    </div>
                  </div>
