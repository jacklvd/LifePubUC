  ...
  return (
    <div className="mt-12">
      <h2 className="text-xl font-bold text-gray-800 mb-6">
        LifePub helps <span className="text-purple-700">comedy</span> organizers
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <CardContent className="p-4">
            <div className="flex flex-col">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-3xl font-bold text-gray-800">5.3M</span>
        ...
        <Card className="bg-gray-50 border-none">
          <CardContent className="p-4">
            <div className="flex flex-col">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-3xl font-bold text-gray-800">2M</span>
        ...
        <Card className="bg-gray-50 border-none">
          <CardContent className="p-4">
            <div className="flex flex-col">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-3xl font-bold text-gray-800">728.2K</span>
                <div className="bg-white p-1 rounded">
