...
const EventLocationPicker = memo(({
  ...
  return (
    <>
      <h3 className="text-base sm:text-lg font-medium mb-2 sm:mb-4">Location</h3>
      {errors.location && (
        <p className="text-red-500 text-xs sm:text-sm mt-1 mb-2" role="alert">{errors.location}</p>
      )}

      {/* Input and Search Button */}
      <div className="flex flex-col">
        <div className="flex items-center gap-2 mb-2" ref={locationInputRef}>
        ...
        {showSuggestions && locationSuggestions.length > 0 && (
          <div
            className="mt-1 bg-white-100 border rounded-md shadow-lg z-50 max-h-64 overflow-y-auto w-full"
            role="listbox"
        ...
        <Button
          variant="link"
          className="text-blue-500 mt-1 h-auto p-0 self-start text-xs sm:text-sm"
          onClick={toggleMap}
          type="button"
