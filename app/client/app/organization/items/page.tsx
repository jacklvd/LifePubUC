                ...
                <div className="p-4">
                  ...
                  <div className="flex flex-wrap gap-2 pt-3 border-t">
                    <div className="relative group">
                      <button className="text-gray-500 hover:text-gray-700 px-2 py-1 rounded hover:bg-gray-100">
                        Status
                        <svg
                      ...
                      <div className="absolute z-10 left-0 mt-1 w-40 bg-white rounded shadow-lg border border-gray-200 invisible group-hover:visible">
                        <button
                          onClick={() =>
                            handleUpdateStatus(item._id, 'available')
                          }
                        ...
                        <button
                          onClick={() =>
                            handleUpdateStatus(item._id, 'reserved')
                          }
                          className="block w-full text-left px-4 py-2 text-sm hover:bg-gray-100"
                        >
                          Mark as Reserved
