...
const CalendarEventPopup: React.FC<CalendarEventPopupProps> = ({
    ...
    useEffect(() => {
        const adjustForMobile = () => {
            ...
            let adjustedTop = typeof position.top === 'number' ? position.top : parseInt(position.top as string, 10)
            let adjustedLeft = typeof position.left === 'number' ? position.left : parseInt(position.left as string, 10)
