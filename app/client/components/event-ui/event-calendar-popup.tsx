...
const CalendarEventPopup: React.FC<CalendarEventPopupProps> = ({ event, onClose, position }) => {
    if (!event) return null

    // Calculate ticket statistics
    const ticketsSold = event.tickets?.reduce((total, ticket) => total + ticket.sold, 0) || 0
    const totalCapacity = event.tickets?.reduce((total, ticket) => total + ticket.capacity, 0) || 0
    ...
    return (
        ...
        >
            ...
            <h3 className="text-lg font-semibold text-purple-950 mb-1">{event.title}</h3>
            ...
            <div className="space-y-2 mb-4 text-sm">
                ...
                <div className="flex items-center gap-2">
                    <Icon name="Calendar" className="h-4 w-4 text-gray-500 flex-shrink-0" />
                    <span className="text-gray-700">{formatDate(String(event.date))}</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                        <div className="flex justify-between items-center mb-1">
                            <span className="text-gray-700">{ticketsSold} / {totalCapacity} tickets sold</span>
            ...
            <div className="flex gap-2 mt-3">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-36">
                        <DropdownMenuItem className="text-red-500 focus:text-red-500" onClick={() => onClose()}>
