...
const getStatusBadge = (status?: string) => {
  switch (status) {
    ...
    default:
      return (
        <Badge className="bg-blue-500 text-white">{status || 'Unknown'}</Badge>
      )
  }
}
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="sm:w-4/5 p-3">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="text-lg font-semibold text-purple-950 mb-1 line-clamp-1">
                {event.title}
              </h3>
          ...
          <div className="mt-2 grid grid-cols-2 gap-y-1 gap-x-2 text-xs">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-gray-700">
                {formatDate(String(event.date), 'display')}
              </span>
            </div>
            <div className="flex items-center gap-1">
