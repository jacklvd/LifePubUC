...
const EventDateTimePicker = ({
    date, setDate, calendarOpen, setCalendarOpen,
        ...
        <div className="grid grid-cols-2 gap-4">
            <div>
                ...
                <div className="flex space-x-2">
                    ...
                    <Select value={startPeriod} onValueChange={(value) => setStartPeriod(value as 'AM' | 'PM')}>
                        <SelectTrigger className="w-16">
            ...
            <div>
                ...
                <div className="flex space-x-2">
                    ...
                    <Select value={endPeriod} onValueChange={(value) => setEndPeriod(value as 'AM' | 'PM')}>
                        <SelectTrigger className="w-16">
                            <SelectValue placeholder="AM/PM" />
                        </SelectTrigger>
                        <SelectContent className='bg-white-100'>
