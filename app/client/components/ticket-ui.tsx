...
const TicketUI: React.FC<TicketUIProps> = ({ eventId }) => {
    ...
    useEffect(() => {
        if (ticketHook.event) {
            ...
            setEventDate(ticketHook.event?.date ? new Date(ticketHook.event.date).toLocaleDateString() : '');
    ...
    }, [ticketHook.event, eventId, setEventId, setEventTitle, setEventDate, setActiveStep, markStepCompleted, completedSteps]);
    ...
    return (
        <div className="container mx-auto p-4">
                ...
                <div className="w-full lg:w-3/4">
                    ...
                    >
                        ...
                        <TabsContent value="admission" className="space-y-4">
                            {ticketHook.tickets.length === 0 ? (
                                <EmptyTicketState onAddClick={() => ticketHook.setIsAddDialogOpen(true)} />
                            ) : (
                                <>
                                    ...
                                    <CapacityCard
                                        ...
                                        onEditCapacity={() => ticketHook.setIsCapacityDialogOpen(true)}
                                    />
                                </>
                            )}
                        </TabsContent>
                        ...
                        {/* Other tab contents */}
                        <TabsContent value="addons">Add-ons content would go here</TabsContent>
                        <TabsContent value="promotions">Promotions content would go here</TabsContent>
                        <TabsContent value="holds">Holds content would go here</TabsContent>
                        <TabsContent value="settings">Settings content would go here</TabsContent>
                    </Tabs>
                </div>
            ...
            <TicketDialogs
                ...
                eventDate={ticketHook.event?.date ? new Date(ticketHook.event.date) : undefined}
