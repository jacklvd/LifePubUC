...
export const calculateEventPosition = (event: Event, columnWidth: number): EventPosition | null => {
...
export const getWeekDaysForDate = (year: number, month: number, day: number): WeekDay[] => {
