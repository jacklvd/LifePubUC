...
export const EventProgressProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    }, [eventId, eventTitle, eventDate, eventLocation, eventStatus, activeStep, completedSteps])
